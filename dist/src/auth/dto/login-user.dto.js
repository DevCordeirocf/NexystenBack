...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Endereço de e-mail do usuário', example: 'usuario@example.com' }),
    (0, class_validator_1.IsEmail)({}, { message: 'O email deve ser um endereço de e-mail válido.' }),
    __metadata("design:type", String)
], LoginUserDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Senha do usuário (mínimo 6 caracteres)', example: 'senha123', minLength: 6 }),
